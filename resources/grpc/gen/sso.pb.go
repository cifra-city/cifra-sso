...
func (x *AccessResp) GetLink() string {
	if x != nil {
		return x.Link
	}
	return ""
...
func (x *InquiryResp) GetEve() Events {
	if x != nil {
		return x.Eve
	}
	return Events_LOGIN
...
var file_resources_grpc_proto_sso_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x20, 0x0a, 0x0a, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x22, 0x2d, 0x0a, 0x0b, 0x49, 0x6e, 0x71, 0x75,
	0x69, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1e, 0x0a, 0x03, 0x65, 0x76, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x73, 0x52, 0x03, 0x65, 0x76, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79,
	...
	,
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2e,
...
var file_resources_grpc_proto_sso_proto_depIdxs = []int32{
	...
	0,  // 2: auth.InquiryResp.eve:type_name -> auth.events
	1,  // 3: auth.Auth.Register:input_type -> auth.RegisterReq
	11, // 4: auth.Auth.Logout:input_type -> auth.Empty
	7,  // 5: auth.Auth.InquiryForChangeRequest:input_type -> auth.InquiryReq
	6,  // 6: auth.Auth.AccessForChanges:input_type -> auth.AccessReq
	2,  // 7: auth.Auth.Login:input_type -> auth.LoginReq
	3,  // 8: auth.Auth.ChangePass:input_type -> auth.ChangePassReq
	5,  // 9: auth.Auth.ChangeUsername:input_type -> auth.ChangeUsernameReq
	4,  // 10: auth.Auth.ChangeEmail:input_type -> auth.ChangeEmailReq
	11, // 11: auth.Auth.Register:output_type -> auth.Empty
